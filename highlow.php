...
* By: Louis Hawkins
*
* Computer generates pseudorandom number and challanges 
* user to guess what it is.
*
* BUG: DOES NOT GENERATE A NEW NUMBER, REUSES ORIGINAL.
* ***************************************************************
*/ 
...
do {
	...
	if ($_mode == "-h"){
		echo "-n [number1] [number2]; will start with lower value and end with higher value.\n-c Cheat; Shows number genereated by computer and exits game.\n\n";
	} else {
			$points = 1010;
			...
			do {
				...
				if($guess == (string) '-c') {
					...
					$_play = ($playAgain == 'yes' || $playAgain == 'y') ? true : false;
				} elseif ($guess < NUMBER) {
